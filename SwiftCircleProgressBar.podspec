#
#  Be sure to run `pod spec lint SwiftCircleProgressBar.podspec' to ensure this is a
...
a circle progress bar control written in swift for ios development
  ...
  s.screenshots  = "https://github.com/xdongliu123/SwiftCircleProgressBar/blob/master/Screenshot/demo.png"
  ...
  s.source       = { :git => "https://github.com/xdongliu123/SwiftCircleProgressBar.git", :commit => "2a2ba91161fea4610b33a43c47f6b8074c717e28" }
